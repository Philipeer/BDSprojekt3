...
import org.but.feec.javafx.HelloApplication;
import org.but.feec.javafx.controllers.HelloController;
...
public class LoginController {
    ...
    private void showEmployeesView(){
        try {
            ...
            fxmlLoader.setLocation(App.class.getResource("/org/but/feec/javafx/fxml/hello-view.fxml"));
            Scene scene = new Scene(fxmlLoader.load(), 570, 500);
            Stage stage = new Stage();
            stage.setTitle("Car Factory Employees Database App");
